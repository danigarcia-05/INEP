...
private:
    ...
    static ConnexioDB* _ins;  // Corregido: el puntero estático debe ser de tipo ConnexioDB*
    ConnexioDB();  // Constructor privado

public:
    static ConnexioDB& getInstance();  // Método estático que retorna un puntero de tipo ConnexioDB*
